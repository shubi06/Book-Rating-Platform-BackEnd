...
public class BookService : IBookService
{
    ...
    public async Task<List<BookDto>> GetBooksAsync(string? search, int? categoryId)
    {
        ...
        {
            _logger.LogInformation("Searching books with term: {SearchTerm}", search);
        ...
        {
            _logger.LogInformation("Returning {Count} books from cache (CategoryId={CategoryId})", cachedBooks.Count, categoryId);
            return cachedBooks;
        }
